...
type
  TMainForm = class(TUniForm)
    ...
    procedure UniEditResponseChange(Sender: TObject);
  private
...
begin
  Result := aQuestionList[random(12)];
end;
...
begin
  ...
  begin
    ...
    begin
      UniEditResponse.Color := clLime;
      UniButtonNewQuestion.Click;
    end
    else
    begin
      UniEditResponse.text := 'Try again :(...';
      UniEditResponse.Color := clRed;
    end;
  end;
end;

procedure TMainForm.UniEditResponseChange(Sender: TObject);
begin
  UniEditResponse.Color := clWindow;
end;
